<div class="inline-block w-full bg-gray-900 " style="height:17.0%;">
    <div class="inline-block w-full flex flex-col flex-nowrap  h-full text-center">
        ...
        <div class="inline-block w-5/6 flex rounded overflow-hidden shadow-lg text-center mx-auto h-full min-w-max">
            ...
            <div class="inline-block basis-1/4 bg-gray-500 flex">
            ...
            <div class="inline-block basis-1/2 bg-gray-500 flex flex-col">
            ...
            <div class="inline-block basis-1/4 flex flex-row content-center bg-gray-500 text-center">
